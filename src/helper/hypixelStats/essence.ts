import { IGetEssence } from '../../types/hypixelStats/essence';

export const getEssence = function getEssence(profile: any): IGetEssence {
  return {
    noInventory: !profile.inventory?.inv_contents,
